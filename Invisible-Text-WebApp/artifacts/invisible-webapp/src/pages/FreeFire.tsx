    ...
    <Layout>
      ...
      >
                ...
                <Tabs value={mode} onValueChange={(v) => setMode(v as ModeKey)}>
                  ...
                  <TabsContent value="generatorA">
                    <p className="text-sm text-muted-foreground mt-2 p-3 rounded-lg border" style={{ backgroundColor: "#00a88410", borderColor: "#00a88430" }}>
                      Uses <strong className="text-foreground">Hangul Filler ({MODES.generatorA.unicode})</strong> — best compatibility with Free Fire. Recommended for most users.
                    </p>
                  </TabsContent>
        ...
        <motion.div variants={fadeIn} className="max-w-4xl mx-auto space-y-4 text-muted-foreground leading-relaxed">
          ...
          <p>
            If you have ever tried adding a blank space in your Free Fire nickname and received an error, you are not alone.
            The game does not accept normal spaces at the beginning or end of a name. However, there is a simple solution:
            special Unicode characters that look empty but are recognized as valid characters by the system.
          </p>
        </motion.div>
        ...
        <motion.div variants={fadeIn} className="max-w-4xl mx-auto border-t border-border pt-10 space-y-6">
          <h2 className="text-3xl font-display font-bold">How to Create a Free Fire Invisible Name</h2>
        ...
        <motion.div variants={fadeIn} className="max-w-4xl mx-auto border-t border-border pt-10 pb-12 space-y-4">
          ...
          <div className="space-y-4 text-muted-foreground leading-relaxed">
            <p>
              An invisible nickname in Free Fire is a simple way to create a unique identity. Instead of using complicated tricks,
              you can generate safe and working invisible text in seconds using the generator above.
            </p>
            <p>
